...
command! FinderCocDefinition call myfinder#finders#coc#definition()
command! FinderCocDeclaration call myfinder#finders#coc#declaration()
command! FinderCocTypeDefinition call myfinder#finders#coc#type_definition()
command! FinderCocImplementation call myfinder#finders#coc#implementation()
command! FinderCocReferences call myfinder#finders#coc#references()
