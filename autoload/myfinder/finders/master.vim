...
function! myfinder#finders#master#start() abort
  ...
  let l:defs = [
        ...
        \ {'text': 'CocDefinition', 'cmd': 'FinderCocDefinition', 'help': 'Go to definition'},
        \ {'text': 'CocDeclaration', 'cmd': 'FinderCocDeclaration', 'help': 'Go to declaration'},
        \ {'text': 'CocTypeDefinition', 'cmd': 'FinderCocTypeDefinition', 'help': 'Go to type definition'},
        \ {'text': 'CocImplementation', 'cmd': 'FinderCocImplementation', 'help': 'Go to implementation'},
        \ {'text': 'CocReferences', 'cmd': 'FinderCocReferences', 'help': 'Find references'},
